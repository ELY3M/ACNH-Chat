...
public partial class MainView : UserControl
{
    ...
    public MainView()
    {
        ...
        ipaddresstext.Text = appSettings.getipaddress;

        connectbutton.Background = Brushes.Aqua;
        startchat.Background = Brushes.Aqua;
        sendbutton.Background = Brushes.Aqua;
    ...
    public void Connect_Click(object sender, RoutedEventArgs e)
    {
        ...
        appSettings.getipaddress = ipaddresstext.Text;
        ...
        if (conSuceded == true)
        {
            connectbutton.Background = Brushes.Lime;
    ...
    public void Sendchat_Click(object sender, RoutedEventArgs e)
    {
    ...
    */
    ...
    private void chattext_TextInput(object? sender, Avalonia.Input.TextInputEventArgs e)
    {
    }
}